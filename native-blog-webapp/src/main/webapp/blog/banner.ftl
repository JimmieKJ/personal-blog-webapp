<div class="banner">
    <div id="slide-holder">
        ...
        <div id="slide-runner">
            ...
            <a href="${recordIndexUrl}" title="生活记录">
                <img style="left: 0px;" id="slide-img-4" src="${contextPath}/resources/img/common/banner_3.jpg" alt="生活记录"/>
            </a>
